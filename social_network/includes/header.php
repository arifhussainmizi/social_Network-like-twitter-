 ...
 <nav class="navbar navbar-default">
 	<div class="container-fluid">
 		<div class="navbar-header">
 			...
 			<a href="home.php" class="navbar-brand">K2.com</a>
 		</div>
 				...
 				<?php 
 				 ...
 				 <?php 
 				 	...
 				 	echo "<li class='dropdown'>
 				 		<a herf='#' class='dropdown-toggle' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'><span><i class='glyphicon glyphicon-chevron-down'></i></span></a>
