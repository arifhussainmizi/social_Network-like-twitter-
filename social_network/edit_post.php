		...
		<div class="col-sm-6">
			...
			<?php 
			 ...
			 <form action="" method="post" id="f">
			 	...
			 	<textarea class="from-control" cols="83" rows="4" name="content"><?php echo  $post_con; ?></textarea>
			 ...
			 <?php 
			 		if(isset($_POST['update'])){
			 			...
			 			$update_post = "update post set post_content='$content' where post_id='$get_id'";
