			...
			if(strlen($upload_image) >= 1 && strlen($content) >= 1){
				...
				if($upload_image=='' && $content == ''){
					...
					if($content==''){
						...
						$insert = "insert into post (user_id, post_content, post_date) values('$user_id', '$content', NOW())";
						$run = mysqli_query($con, $insert);
...
function get_posts(){
				...
				<div class='panel panel-info'>
					<div class='panel-body'>
						<form action='' method='post' class='form-inline'>
							<textarea placeholder='Write your commant here....' class='bp-cmmnt-textarea' name='comment'></textarea>
	...
	function user_posts(){
		...
		while ($row_user=mysqli_fetch_array($run_posts)) {
			...
			$get_user="select user_email from users where user_id='$u_id' ";
			$run_user=mysqli_query($con, $get_user);
			$row= mysqli_fetch_array($run_user);
	...
	function results(){
		...
		$get_posts = "select * from post where post_content like %$search_query% OR upload_image like %$search_query%";
			...
			<div class='row'>
				...
				<div class='col-sm-4'>
					<a href='user_profile.php?u_id=$user_id'>
						<img src='images/$user_image' width='150px' height='140px' title='$username' style='float: left; margin: 1px;'>
					</a>
				</div><br><br>
			<div class='col-sm-6'>
				<a style='text-decoration: none; cursor: pointer; columns: #3897f0' href='user_profile.php?u_id=$user_id'>
