		 	 			...
		 	 			<div class='row'>
		 	 				...
		 	 				<center>
		 	 					<div class='col-sm-3' style='background-color: #e6e6e6;'>
		 	 						...
		 	 						<img class='img-circle' src='images/$image' width='150' height='150'>
		 	 						<br><br>
		 	 						<ul class='list-group'>
					...
					echo"
						<div id='own_posts'>
							<div class='row'>
								...
								<div class='col-sm-6'>
									<h3><a style='text-decoration: none; cursor: pointer; color:#3897f0; ' href='user_profile.php?u_id=$user_id'></a>$user_name</h3>
